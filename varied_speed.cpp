...
int main()
{
     ...
     * resolution: 0.05
     */
    surfaceGrid grid(-0.02000000, 10.00000, -10.000000, 10.000000, 0.0200000);

    /* grow the ship course for 20 seconds */
    for (float time = 0; time < 5; time += timestep)
    {
        /* ship position */
        float posX = velX*time;
        float posY = -0.06*posX*posX + 6;
    ...
    grid.outputData("/scrpit/varied.csv");
